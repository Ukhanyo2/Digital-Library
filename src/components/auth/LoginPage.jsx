        ...
        {!resetMode ? (
          <>
            ...
            <p className="text-white/60 mb-8 font-light tracking-wide" style={{ fontFamily: "'Inter', sans-serif" }}>
              Access your premium collection
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-right">
                <button
                  ...
                  className="text-sm text-teal-300 hover:text-teal-200 transition duration-300 font-light"
                >
                  Forgot Password?
                </button>
              </div>
          ...
          <>
            ...
            <form onSubmit={handleForgotPassword} className="space-y-6">
              ...
              {resetMessage && (
                <p className="text-teal-300 text-sm bg-teal-500/20 border border-teal-400/30 p-4 rounded-xl font-light">
                  {resetMessage}
                </p>
              )}
              ...
              <button
                ...
                className="w-full text-center text-sm text-white/50 hover:text-teal-300 transition duration-300 font-light mt-4"
              >
                ← Back to Sign In
              </button>
            </form>
